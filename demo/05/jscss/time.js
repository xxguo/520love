const startDatetime= new Date('20230520');
function showTime() {
	...
	if (seconds < 10)
	    seconds = "0" + seconds;
	var currentTimeString = "Dear 岳红 Seven:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----郭星2024   2024-05-20</c>";
